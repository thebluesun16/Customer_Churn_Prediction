...
with tab2:
    st.markdown("### Feature Importance Across All Customers")
    ...
    st.image("risk_segmentation.png")
            ...
            if st.button("🔍 Predict & Analyse", use_container_width=True):
                ...
                try:
                    ...
                    try:
                        ...
                        shap_df = pd.DataFrame({'Feature': feature_columns, 'SHAP Value': sv}).sort_values('SHAP Value', key=abs, ascending=False).head(10)
                    ...
                    if GEMINI_API_KEY == "YOUR_GEMINI_API_KEY_HERE":
                        st.warning("Add your Gemini API key to enable AI retention recommendations. Get it free at aistudio.google.com")
                    else:
